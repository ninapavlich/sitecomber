# Generated by Django 2.2.3 on 2019-07-17 19:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('test', models.CharField(choices=[('sitecomber.apps.tests.core.PageUpTest', 'PageUpTest'), ('sitecomber.apps.tests.core.BrokenLinkTest', 'BrokenLinkTest')], max_length=255)),
