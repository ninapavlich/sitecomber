# Generated by Django 2.2.3 on 2019-07-17 05:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SiteTestResult',
            fields=[
                ('basetestresult_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='shared.BaseTestResult')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
            ...
            bases=('shared.basetestresult', models.Model),
        ),
        migrations.CreateModel(
